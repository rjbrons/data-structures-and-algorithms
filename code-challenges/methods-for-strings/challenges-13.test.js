...
const standardizePhoneNumbers = arr => {
  return arr.map(e => e.substring(1, 4) + e.substring(6, 9) + e.substring(10));
};
...
const unenrollBrook = arr => {
  return arr.map(e => e.filter(el => !el.includes('Brook')));
};
