...
const isCapitalized = str => {
  let expr = /\b[A-Z]\w+/g;
  return str.match(expr) ? str.match(expr) : [];
};
...
let hangman = str => {
  let expr = /[aeiouAEIOU]/g;
  return str.replace(expr, '_');
};
