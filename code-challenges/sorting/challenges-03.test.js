...
------------------------------------------------------------------------------------------------ */
// stack overflow ftw: https://stackoverflow.com/questions/51165/how-to-sort-strings-in-javascript
const alphabetizeBetter = arr => {
  return arr.sort((a, b) => a.localeCompare(b, { sensitivity: 'base' }));
};
...
const sortSchedule = arr => {
  ...
  return arr.sort(function(a, b) {
    if (weekdays.indexOf(a.dayOfWeek) < weekdays.indexOf(b.dayOfWeek))
      return -1;
    else if (weekdays.indexOf(a.dayOfWeek) > weekdays.indexOf()) return 1;
    else {
